const polkadotTypes = (function (exports, util, utilCrypto) {
  ...
  const definitions$g = {
    rpc: {},
    types: _objectSpread$q({}, dmpQueue)
  };
  ...
  const slotTypes = _objectSpread$p(_objectSpread$p({}, oldTypes), {}, {
    AuctionIndex: 'u32',
  ...
  const definitions$f = {
    rpc: {},
    types: _objectSpread$o(_objectSpread$o(_objectSpread$o(_objectSpread$o(_objectSpread$o({}, cumulusTypes), hrmpTypes), proposeTypes), slotTypes), {}, {
  ...
  const definitions$c = {
    rpc: {},
    types: _objectSpread$n(_objectSpread$n(_objectSpread$n(_objectSpread$n(_objectSpread$n(_objectSpread$n({}, location), xcm), v0$1), v1), v2), {}, {
      DoubleEncodedCall: {
        encoded: 'Vec<u8>'
      },
      XcmOriginKind: {
  ...
  const definitions$b = {
    rpc: {},
    types: _objectSpread$m(_objectSpread$m(_objectSpread$m({}, layout), spec), {}, {
      ContractProject: {
  ...
  const definitions$a = {
    rpc: {},
    types: _objectSpread$l(_objectSpread$l({}, v0), {}, {
      SiField: {
        name: 'Option<Text>',
        type: 'SiLookupTypeId',
        typeName: 'Option<Text>',
  ...
  const rpc = _objectSpread$k(_objectSpread$k(_objectSpread$k({}, netRpc), web3Rpc), {}, {
    accounts: {
  ...
  const v14 = {
    ...
    ErrorMetadataV14: _objectSpread$j(_objectSpread$j({}, SiVariant), {}, {
      args: 'Vec<Type>'
    }),
    EventMetadataV14: _objectSpread$j(_objectSpread$j({}, SiVariant), {}, {
      args: 'Vec<Type>'
    }),
    FunctionArgumentMetadataV14: 'FunctionArgumentMetadataV13',
    FunctionMetadataV14: _objectSpread$j(_objectSpread$j({}, SiVariant), {}, {
  ...
  */
  ...
  function encodeSubTypes(registry, sub, asEnum, extra) {
    ...
    const inner = sub.reduce((result, type) => _objectSpread$f(_objectSpread$f({}, result), {}, {
      [type.name]: encodeTypeDef(registry, type)
    }), _objectSpread$f({}, extra));
  ...
  function encodeEnum(registry, typeDef) {
    util.assert(typeDef.sub && Array.isArray(typeDef.sub), 'Unable to encode Enum type');
  ...
  function encodeStruct(registry, typeDef) {
    util.assert(typeDef.sub && Array.isArray(typeDef.sub), 'Unable to encode Struct type');
    return encodeSubTypes(registry, typeDef.sub, false, _objectSpread$f({}, typeDef.alias ? {
      _alias: [...typeDef.alias.entries()].reduce((all, [k, v]) => _objectSpread$f(_objectSpread$f({}, all), {}, {
        [k]: v
      }), {})
    } : {}));
  }
  ...
  function encodeTuple(registry, typeDef) {
    util.assert(typeDef.sub && Array.isArray(typeDef.sub), 'Unable to encode Tuple type');
  ...
  function encodeUInt(registry, {
    ...
    util.assert(util.isNumber(length), 'Unable to encode VecFixed type');
    return `${type}<${length}>`;
  } // eslint-disable-next-line @typescript-eslint/no-unused-vars
  ...
  const encoders = {
    ...
    [exports.TypeDefInfo.DoNotConstruct]: (registry, typeDef) => encodeDoNotConstruct(registry, typeDef),
    [exports.TypeDefInfo.Enum]: (registry, typeDef) => encodeEnum(registry, typeDef),
    [exports.TypeDefInfo.HashMap]: (registry, typeDef) => encodeWithParams(registry, typeDef, 'HashMap'),
    [exports.TypeDefInfo.Int]: (registry, typeDef) => encodeUInt(registry, typeDef, 'Int'),
    ...
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    [exports.TypeDefInfo.Plain]: (registry, typeDef) => typeDef.displayName || typeDef.type,
    ...
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    [exports.TypeDefInfo.Set]: (registry, typeDef) => typeDef.type,
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    [exports.TypeDefInfo.Si]: (registry, typeDef) => typeDef.lookupName || typeDef.type,
    [exports.TypeDefInfo.Struct]: (registry, typeDef) => encodeStruct(registry, typeDef),
    [exports.TypeDefInfo.Tuple]: (registry, typeDef) => encodeTuple(registry, typeDef),
    [exports.TypeDefInfo.UInt]: (registry, typeDef) => encodeUInt(registry, typeDef, 'UInt'),
    [exports.TypeDefInfo.Vec]: (registry, typeDef) => encodeWithParams(registry, typeDef, 'Vec'),
    [exports.TypeDefInfo.VecFixed]: (registry, typeDef) => encodeVecFixed(registry, typeDef)
  };

  function encodeType(registry, typeDef, withLookup = true) {
    const encoder = encoders[typeDef.info];
    util.assert(encoder, () => `Cannot encode type ${util.stringify(typeDef)}`);
    return withLookup && typeDef.lookupName ? typeDef.lookupName : encoder(registry, typeDef);
  }

  function encodeTypeDef(registry, typeDef) {
    util.assert(!util.isUndefined(typeDef.info), () => `Invalid type definition with no instance info, typeDef=${util.stringify(typeDef)}`); // In the case of contracts we do have the unfortunate situation where the displayName would
  ...
  function withTypeString(registry, typeDef) {
    return _objectSpread$f(_objectSpread$f({}, typeDef), {}, {
  ...
  const allExtensions = _objectSpread$e(_objectSpread$e(_objectSpread$e(_objectSpread$e({}, substrate$1), polkadot), shell), statemint); // the v4 signed extensions prior to the point of exposing these to the metadata.
  ...
  function expandExtensionTypes(extensions, type, userExtensions = {}) {
    ...
    .map(key => userExtensions[key] || allExtensions[key]).filter(info => !!info).reduce((result, info) => _objectSpread$e(_objectSpread$e({}, result), info[type]), {});
  }
  ...
  class GenericExtrinsicEra extends Enum {
    ...
    static _decodeExtrinsicEra(value = new Uint8Array()) {
      ...
      } else if (!value || util.isU8a(value)) {
  ...
  class GenericSignerPayload extends Struct {
    constructor(registry, value) {
      const extensionTypes = _objectSpread$b(_objectSpread$b({}, registry.getSignedExtensionTypes()), registry.getSignedExtensionExtra());

      super(registry, _objectSpread$b(_objectSpread$b({}, extensionTypes), knownTypes), value); // add all extras that are not in the base types
    ...
    toPayload() {
      return _objectSpread$b(_objectSpread$b({}, Object.keys(this._extraTypes).reduce((map, key) => {
  ...
  class GenericExtrinsicPayloadV4 extends Struct {
    constructor(registry, value) {
      super(registry, _objectSpread$a(_objectSpread$a({
        method: 'Bytes'
  ...
  class GenericExtrinsicSignatureV4 extends Struct {
    constructor(registry, value, {
      ...
      super(registry, _objectSpread$9({
        signer: 'Address',
        // eslint-disable-next-line sort-keys
  ...
  class GenericPortableRegistry extends Struct {
    constructor(registry, value) {
      ...
      _classPrivateFieldBase(this, _names)[_names] = extractNames(registry, this.types);
    }
    /**
    ...
    getTypeDef(lookupId) {
      ...
      if (!_classPrivateFieldBase(this, _typeDefs)[_typeDefs][lookupIndex]) {
        ...
        _classPrivateFieldBase(this, _typeDefs)[_typeDefs][lookupIndex] = {
  ...
  function _extractFields2(lookupIndex, fields) {
    ...
    if (fields.length === 0) {
      ...
      return _objectSpread$7(_objectSpread$7({}, typeDef), lookupIndex === -1 ? {} : {
        lookupIndex,
        lookupName: _classPrivateFieldBase(this, _names)[_names][lookupIndex],
    ...
    return withTypeString(this.registry, _objectSpread$7(_objectSpread$7(_objectSpread$7({
  ...
  function _extractFieldsAlias2(fields) {
    ...
    const sub = fields.map(({
      ...
      return _objectSpread$7(_objectSpread$7({}, typeDef), {}, {
  ...
  function _extractHistoric2(_, type) {
    return _objectSpread$7(_objectSpread$7({}, getTypeDef(type)), {}, {
  ...
  function _extractVariantEnum2(lookupIndex, variants) {
    ...
    [...variants].sort((a, b) => a.index.cmp(b.index)).forEach(({
      ...
      sub.push(_objectSpread$7(_objectSpread$7({}, _classPrivateFieldBase(this, _extractFields)[_extractFields](-1, fields)), {}, {
        index: index.toNumber(),
        name: name.toString()
      }));
    });
  ...
  function createStorageType(registry, entryType) {
    if (entryType.isMap) {
      return [_objectSpread$6(_objectSpread$6({}, entryType.asMap), {}, {
        hasher: createStorageHasher(registry, entryType.asMap.hasher)
      }), 1];
    }

    if (entryType.isDoubleMap) {
      return [_objectSpread$6(_objectSpread$6({}, entryType.asDoubleMap), {}, {
  ...
  function convertModule(registry, mod) {
    ...
    return registry.createType('ModuleMetadataV10', _objectSpread$6(_objectSpread$6({}, mod), {}, {
      storage: storage ? _objectSpread$6(_objectSpread$6({}, storage), {}, {
        items: storage.items.map(item => _objectSpread$6(_objectSpread$6({}, item), {}, {
  ...
  function toV12(registry, {
    ...
    return registry.createType('MetadataV12', {
      extrinsic,
      modules: modules.map(mod => registry.createType('ModuleMetadataV12', _objectSpread$5(_objectSpread$5({}, mod), {}, {
        index: 255
      })))
    });
  }
  ...
  function getModuleTypes({
    ...
    return _objectSpread$4(_objectSpread$4({}, typesModules$1[section] || {}), ((_knownTypes$typesAlia = knownTypes.typesAlias) === null || _knownTypes$typesAlia === void 0 ? void 0 : _knownTypes$typesAlia[section]) || {});
  }
  ...
  function createModule(registry, mod, {
    ...
    return registry.createType('ModuleMetadataLatest', _objectSpread$3(_objectSpread$3({}, mod), {}, {
  ...
  function toU8a(value = EMPTY_U8A) {
    return util.isHex(value) ? toU8a(util.u8aToU8a(value)) : util.isU8a(value) && value.length === 0 ? EMPTY_METADATA : value;
  }
  ...
  function decorateConstants(registry, {
    ...
    return modules.reduce((result, {
      ...
      result[util.stringCamelCase(name)] = constants.reduce((newModule, meta) => {
        ...
        const codec = registry.createType(type, util.hexToU8a(meta.value.toHex()));
        codec.meta = meta;
  ...
  function decorateErrors(_, {
    ...
    return modules.reduce((result, {
      ...
      result[util.stringCamelCase(name)] = errors.reduce((newModule, meta, errorIndex) => {
  ...
  function decorateEvents(_, {
    ...
    return modules.filter(({
      ...
      const sectionIndex = metaVersion >= 12 ? index.toNumber() : _sectionIndex;
      result[util.stringCamelCase(name)] = events.unwrap().reduce((newModule, meta, eventIndex) => {
  ...
  function createUnchecked(registry, section, callIndex, callMetadata) {
    ...
    const extrinsicFn = (...args) => {
      util.assert(expectedArgs.length === args.length, () => `Extrinsic ${section}.${funcName} expects ${expectedArgs.length.valueOf()} arguments, got ${args.length}.`);
  ...
  function decorateExtrinsics(registry, {
    ...
    return modules.filter(({
      ...
      result[section] = calls.unwrap().reduce((newModule, callMetadata, methodIndex) => {
        newModule[util.stringCamelCase(callMetadata.name)] = createUnchecked(registry, section, new Uint8Array([sectionIndex, methodIndex]), callMetadata);
        return newModule;
      }, {});
      return result;
    }, {});
  ...
  function createKeyRaw(registry, itemFn, keys, hashers, args) {
    return util.u8aConcat(utilCrypto.xxhashAsU8a(itemFn.prefix, 128), utilCrypto.xxhashAsU8a(itemFn.method, 128), ...keys.map((type, index) => getHasher(hashers[index])(registry.createType(type.toString(), args[index]).toU8a())));
  }
  /** @internal */
  ...
  function createKey(registry, itemFn, keys, hashers, args) {
    ...
    util.assert(Array.isArray(args), () => `Call to ${util.stringCamelCase(section || 'unknown')}.${util.stringCamelCase(method || 'unknown')} needs ${keys.length} arguments, provided in tuple format`);
  ...
  function extendPrefixedMap(registry, itemFn, storageFn) {
    ...
    storageFn.iterKey = extendHeadMeta(registry, itemFn, storageFn, (...args) => {
      util.assert(args.length === 0 || type.isDoubleMap && args.length === 1 || type.isNMap && args.length < type.asNMap.hashers.length, () => `Iteration ${util.stringCamelCase(section || 'unknown')}.${util.stringCamelCase(method || 'unknown')} needs arguments to be at least one less than the full arguments, found [${args.join(', ')}]`);
  ...
  function injectEvents(registry, metadata, metadataEvents) {
    ...
    metadata.asLatest.modules.filter(({
      ...
      events.unwrap().forEach((meta, methodIndex) => {
        ...
        metadataEvents[util.u8aToHex(new Uint8Array([sectionIndex, methodIndex]))] = class extends GenericEventData {
          constructor(registry, value) {
  ...
  class TypeRegistry {
    ...
    getOrThrow(name, msg) {
      return util.assertReturn(this.get(name), msg || `type ${name} not found`);
    }
    ...
    setMetadata(metadata, signedExtensions, userExtensions) {
      ...
      this.setSignedExtensions(signedExtensions || (metadata.asLatest.extrinsic.version.gt(util.BN_ZERO) ? metadata.asLatest.extrinsic.signedExtensions.map(key => key.toString()) : fallbackExtensions), userExtensions); // setup the chain properties with format overrides
