...
export function createPair({
  ...
  return {
    ...
    decryptMessage: (encryptedMessageWithNonce, senderPublicKey) => {
      ...
      return naclOpen(u8aToU8a(encryptedMessageWithNonce.slice(24, encryptedMessageWithNonce.length)), u8aToU8a(encryptedMessageWithNonce.slice(0, 24)), convertPublicKeyToCurve25519(u8aToU8a(senderPublicKey)), convertSecretKeyToCurve25519(secretKey));
    },
    derive: (suri, meta) => {
