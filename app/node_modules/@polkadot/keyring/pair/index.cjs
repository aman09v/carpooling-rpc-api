...
function createPair({
  ...
  return {
    ...
    decryptMessage: (encryptedMessageWithNonce, senderPublicKey) => {
      ...
      return (0, _utilCrypto.naclOpen)((0, _util.u8aToU8a)(encryptedMessageWithNonce.slice(24, encryptedMessageWithNonce.length)), (0, _util.u8aToU8a)(encryptedMessageWithNonce.slice(0, 24)), (0, _utilCrypto.convertPublicKeyToCurve25519)((0, _util.u8aToU8a)(senderPublicKey)), (0, _utilCrypto.convertSecretKeyToCurve25519)(secretKey));
    },
    derive: (suri, meta) => {
