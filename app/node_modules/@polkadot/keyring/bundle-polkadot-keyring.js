  ...
  function createPair({
    ...
    return {
      ...
      decryptMessage: (encryptedMessageWithNonce, senderPublicKey) => {
        ...
        return utilCrypto.naclOpen(util.u8aToU8a(encryptedMessageWithNonce.slice(24, encryptedMessageWithNonce.length)), util.u8aToU8a(encryptedMessageWithNonce.slice(0, 24)), utilCrypto.convertPublicKeyToCurve25519(util.u8aToU8a(senderPublicKey)), utilCrypto.convertSecretKeyToCurve25519(secretKey));
      },
      derive: (suri, meta) => {
    ...
    createFromUri(_suri, meta = {}, type = this.type) {
      ...
      if (isPhraseHex) {
        ...
        if ([12, 15, 18, 21, 24].includes(parts.length)) {
          ...
          util.assert(str.length <= 32, 'specified phrase is not a valid mnemonic and is invalid as a raw seed at > 32 bytes');
          seed = util.stringToU8a(str.padEnd(32));
        }
      }
